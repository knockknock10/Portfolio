...
const Timeline = ({ data, title, subtitle }) => {
  return (
    <div className="w-full py-32 sm:py-40 px-6 sm:px-12 max-w-7xl mx-auto">
      {/* Title block */}
      ...
      <div className="relative max-w-5xl mx-auto pb-10">
        ...
        <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-[2px] bg-neutral-850/60 -translate-x-1/2 overflow-hidden [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)]">
          <div className="absolute inset-x-0 top-0 w-full bg-gradient-to-b from-purple-600 via-indigo-500 to-transparent rounded-full" />
        </div>
