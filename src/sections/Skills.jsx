...
const Skills = () => {
  ...
  return (
    <section 
      id="skills" 
      className="w-full py-32 sm:py-40 bg-bg-primary border-b border-border-card relative overflow-hidden"
    >
          ...
          {categories.map((cat, idx) => {
            ...
            return (
              <motion.div
                ...
                className="p-8 rounded-2xl border border-neutral-850 bg-bg-card transition-all duration-300 hover:border-purple-500/25 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.35)] flex flex-col justify-between"
              >
                <div>
                  {/* Card Header */}
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3.5">
                      <div className="p-3 rounded-xl bg-bg-darker/60 border border-neutral-850">
